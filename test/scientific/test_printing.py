...
def test_numeric_result():
    ...
    additional_tests = [
        ...
        (1.234, 0.193, "(1.2 +/- 0.2)"),
        (0.1, 1.0, "(0 +/- 1)"),
        (234.23424, 10.0, "(2.3 +/- 0.1)*10^(2)"),
        (0.0, 0.0, "(0.0 +/- 0)"),  # should really be (0 +/- 0)
        (10.0, 0.0, "(1 +/- 0)*10^(1)"),  # should really be (1.0 +/- 0)*10^(1)
        (0.0, 10.0, "(0 +/- 1)*10^(1)"),
        (0.123456789, 0.987654321, "(1 +/- 10)*10^(-1)"),
        (123456789.0, 987654321.0, "(1 +/- 10)*10^(8)"),
...
def test_numeric_result_with_zero_uncertainty():
    value, uncertainty, expected = (123.456789e-9, 0.0, "(1.23456789 +/- 0)*10^(-7)")
